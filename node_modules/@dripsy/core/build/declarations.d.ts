...
export declare type Shadows = Pick<ViewStyle, 'elevation' | 'shadowColor' | 'shadowOffset' | 'shadowOpacity' | 'shadowRadius'>;
export declare type TextShadows = Pick<TextStyle, 'textShadowColor' | 'textShadowOffset' | 'textShadowRadius'>;
declare type OnlyAllowThemeValues = 'always' | 'never';
declare type FontWeight = 'normal' | 'bold' | '100' | '200' | '300' | '400' | '500' | '600' | '700' | '800' | '900' | 'normal';
declare type NativeStyle = ViewStyle | TextStyle | ImageStyle;
declare type BaseThemeWithNativeStyles = {
...
export declare type DripsyThemeWithoutIgnoredKeys<Theme = DripsyCustomTheme> = Omit<Theme, keyof Pick<DripsyBaseTheme, 'breakpoints' | 'customFonts' | 'useBodyStyles' | 'useLocalStorage' | 'useCustomProperties' | 'useColorSchemeMediaQuery' | 'types' | 'initialColorModeName' | 'useBorderBox'>>;
export {};
