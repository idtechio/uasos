...
import CompositionSection from "../Compositions/CompositionSection";
...
import ModalPicture from "../../assets/images/PasswordReset.png";
...
const FormInitPasswordReset = () => {
  ...
  return (
    <>
      <CompositionSection flexGrow="2" paddingT={40} paddingR={15} paddingL={15}>
